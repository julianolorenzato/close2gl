...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.91.6"
  WORKING_DIRECTORY "/home/juliano/Masters/GraphicsComputing/close2gl-without-rasterization/external/imgui"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/juliano/Masters/GraphicsComputing/close2gl-without-rasterization/external/imgui'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/juliano/Masters/GraphicsComputing/close2gl-without-rasterization/external/imgui'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
